...
public class Processing implements Serializable {
    ...
    public Processing(String title, String remark, String tstatus, String phone, String fullname, String flatBlock, String building, String districtEN, String island) {
        this.title = title;
        this.remark = remark;
