...
public class LocalScheduleDAO implements Serializable {
    ...
    public LocalScheduleDAO(Context context) {
    ...
    public LocalSchedule getRecord(Cursor cursor) {
        ...
        sch.setAstatus(cursor.getString(1));
        sch.setAremark(cursor.getString(2));
        sch.setTaskID(cursor.getString(3));
        sch.setFlatBlock(cursor.getString(4));
        sch.setBuilding(cursor.getString(5));
        sch.setDistrictEN(cursor.getString(6));
        sch.setAppointmentTime(cursor.getString(7));
        sch.setEmpID(cursor.getString(8));
        sch.setEmpName(cursor.getString(9));
        sch.setCustID(cursor.getString(10));
        sch.setCustFullName(cursor.getString(11));
        sch.setCustPhone(cursor.getString(12));
